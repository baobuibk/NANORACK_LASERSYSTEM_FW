...
// Commands
#define FSP_CMD_RESPONSE_DONE		0
#define FSP_CMD_PMU_GET_TEMP		1
#define FSP_CMD_PMU_GET_BAT_VOL		2
#define FSP_CMD_PMU_GET_PARAG_IN	3
#define FSP_CMD_PMU_GET_PARAG_OUT	4
#define FSP_CMD_PMU_SET_TEMP_POINT	5
#define FSP_CMD_PMU_SET_OUTPUT		6
#define FSP_CMD_PMU_SET_PWM			7
#define FSP_CMD_PMU_GET_ALL			8
#define FSP_CMD_PMU_SET_HEATER		9
#define FSP_CMD_PMU_SET_AUTO		10
...
#define FSP_PKT_MAX_LENGTH              37     /**< Maximum packet length in bytes. */
#define FSP_PAYLOAD_MAX_LENGTH          30     /**< Maximum packet payload length in bytes. */
